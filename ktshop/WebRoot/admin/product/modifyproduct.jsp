...
<s:form name="form" id="form" method="POST" action="modifyProduct!modify.action?id=%{#product.id}">  
  <table width="100%" height="100%" cellspacing="0" cellpadding="0" border="1" align="center" >
  <tr><td>
<table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0" border="0">
  <tr> 
...
/>
  ...
  <tr>
  <td colspan="3"><s:submit value="修改" align="center" style="width:90px;height:40px;"/>
  </td></tr>
</table>
</td></tr></table>
 </s:form> 
