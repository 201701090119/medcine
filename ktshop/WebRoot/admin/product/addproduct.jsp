...
<s:form name="form" id="form" method="POST" action="productAction!save">
  <table align="center" width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#2da8fa">
  <tr>
  <td>   
 <table width="100%" border="0" cellpadding="0" cellspacing="1">
  <tr bgcolor="#FFFFFF"> 
    <td colspan="3"><s:textfield  name="productname" label="产品名称" size="80"/></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td colspan="3">
...
size="100"/> </td>
  ...
  <tr>
  <td colspan="3" bgcolor="#FFFFFF"><s:textfield  name="price" label="价格" size="6"/></td><td bgcolor="#FFFFFF"></td>
  </tr>
     <tr bgcolor="#FFFFFF">
     <td>是否推荐</td><td>
          <div align="right">
  ...
  <tr bgcolor="#FFFFFF"> 
    <td>产品品简介:</td>
    <td height="20" style="width: 1132px; ">
...
<sx:textarea name="parameter"></sx:textarea>
  ...
  <tr bgcolor="#FFFFFF">
  <td colspan="3"><br><s:submit  value="增加" align="center" style="width:90px;height:40px;"/>
  </td></tr>
</table>
</td>
</tr></table>
