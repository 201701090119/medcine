...
<html>
  <head>
    ...
    <title><s:property value="%{#news.title}"/>新闻频道</title>
...
-->
  ...
  <body><table align="center" width="1224"><tr><td width="200"><s:a href="index.jsp"><h1>首页</s:a></td><td><div align="center"><img src="./images/banner2.jpg" width="468" height="80"></div></td>
  </tr>
