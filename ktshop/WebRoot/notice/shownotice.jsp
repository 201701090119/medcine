...
<html>
  <head>
    ...
    <title><s:property value="%{#notice.title}"/>-公告</title>
...
-->
  ...
  <body><table align="center" width="1224"><tr><td width="200"><s:a href="index.jsp"><h1>首页</h1></s:a></td><td height="100"><div align="center"><img src="./images/banner2.jpg" width="468" height="80"></div></td>
  </tr>
