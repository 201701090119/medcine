...
<html>
  ...
  <table width="1024" border="0" align="center">
    <tr>
      <td width="236"><a href="./index.jsp"><h1>首页</a></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td valign="top">搜索:
  <select name="searchName">  <option value="productname">产品名称</option></select><input type="text" name="searchValue" value="" size="10"/>  <input type="button" value="查询" onClick="doSearch();"> <br/>
   <b> 产品列表:</b><br>
  ...
  <td background="./images/tablebg.jpg"><strong>编号</strong></td><td background="./images/tablebg.jpg"><strong>产品名称 </strong></td> <td background="./images/tablebg.jpg"><strong>图片</strong></td><td background="./images/tablebg.jpg"><strong>大类</strong></td><td background="./images/tablebg.jpg"><strong>小类</strong></td> <td background="./images/tablebg.jpg"><strong>价格</strong></td><td background="./images/tablebg.jpg"><strong>详细介绍</strong></td><td background="./images/tablebg.jpg"><strong>购物车</strong></td></tr>       
       <s:iterator value="pageBean.list7">         
          <tr bgcolor="#ffffff" align="center">
          <td><s:property value="id"/></td>
          <td>
            <s:property value="productname"/>            </td><td>
             <a href="images/<s:property value="pic"/>"><img src="images/<s:property value="pic"/>" width="100" height="100" border="0"/></a> 
            </td>
            <td>
            ...
            <td><a href="showProduct!get?id=<s:property value="id"/>">详细介绍</a></td>
            <td>
            <a href="addCart!add?id=<s:property value="id"/>">放入购物车</a>            </td> 
          </tr>  
        </s:iterator>
      </table>    </td>
    </tr>
